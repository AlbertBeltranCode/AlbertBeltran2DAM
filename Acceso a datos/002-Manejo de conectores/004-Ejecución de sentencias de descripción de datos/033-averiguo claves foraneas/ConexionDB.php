...
class conexionDB // Defino una nueva clase para manejar la conexión a la base de datos
{
	...
	public function seleccionaTabla($tabla)
	{
		...
		while ($row = mysqli_fetch_assoc($result)) {
			...
			$restricciones[] = $row; // Agrego la fila al array de restricciones
		}

		var_dump($restricciones); // Muestro las restricciones en pantalla para depuración

		$query = "SELECT * FROM " . $tabla . ";"; // Formulo una consulta para seleccionar todos los registros de la tabla
