...
class conexionDB // Define una clase llamada 'conexionDB'
{
	...
	private $usuario; // Propiedad privada para almacenar el nombre de usuario de la base de datos
	private $contrasena; // Propiedad privada para almacenar la contraseña de la base de datos
	private $basededatos; // Propiedad privada para almacenar el nombre de la base de datos
	private $conexion; // Propiedad privada para almacenar la conexión a la base de datos
