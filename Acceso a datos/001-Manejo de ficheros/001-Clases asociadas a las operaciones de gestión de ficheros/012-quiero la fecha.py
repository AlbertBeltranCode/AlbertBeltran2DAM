...
for archivo in lista: #Mediante un bucle for, recorremos la lista por cada archivo de el directorio fotos
    ...
    cadena = datosexif[306].replace(":","").replace(" ","") #Recogemos el valor 306, que en este caso es la fecha de la toma de la foto y nos aseguramos de remplazar los : por huecos
    print(cadena) #Mostramos en la informacion de la imagen por pantalla
