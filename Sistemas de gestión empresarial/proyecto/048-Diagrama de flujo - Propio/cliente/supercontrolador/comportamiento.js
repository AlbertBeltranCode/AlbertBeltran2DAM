            ...
            fetch("../../servidor/?o=tabla&tabla="+tabla)                            // LLamo a un microservicio que me da la lista de tablas y le paso la tabla como parametro
                ...
                .then(datos => {
                    ...
                    datos.forEach(function(registro){                                       // Como datos es un array, hago un forEach para repasarlo
                        ...
                        nuevacolumna.classList.add("icono-papelera"); // Agrego la clase para efectos CSS
                        ...
                        nuevacolumna.onclick = function () {
                            ...
                            fetch("../../servidor/eliminar_dato.php?tabla=" + tabla + "&id=" + identificador); // Hago una petición para eliminar un registro
                            this.parentElement.remove(); // Elimino visualmente el elemento
                        };
