        ...
        datos.forEach(function(registro){                                       // Como datos es un array, hago un forEach para repasarlo
            ...
            if(listaaplicaciones.length > 0){												// Si hay aplicaciones para esta entidad
            	...
            	selector.onchange = function () {
                    ...
                    if (opcionSeleccionada === "ficha_de_cliente") {
                        console.log("Cargando ficha de cliente:", clave_primaria);
                
                        let seccion = document.querySelector("section");
                        seccion.innerHTML = `<iframe src='apps/clientes/ficha_de_cliente/index.html?entidad=clientes&id=${clave_primaria}'></iframe>`;
                    } else {
                        console.log("Opción no implementada:", opcionSeleccionada);
                    }
                };
